...
#SIR Algorithm
The algorithm takes each infected individual, then, based on the infection and recovery frequency it decides whether this individual will recover or infect another individual in the population. If it infects another individual, the algorithm checks whether the randomly selected individual is already susceptible (since it cannot be infected if it is recovered) and only then makes it infected. This process goes on until the entire population is recovered and cannot get infected anymore.
